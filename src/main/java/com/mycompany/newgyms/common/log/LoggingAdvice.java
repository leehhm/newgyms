package com.mycompany.newgyms.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.mycompany.newgyms.*.service.*.*(..)) or "
			+ "execution(* com.mycompany.newgyms.*.dao.*.*(..))")
	...
	@After("execution(* com.mycompany.newgyms.*.service.*.*(..)) or "
			+ "execution(* com.mycompany.newgyms.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.mycompany.newgyms.*.service.*.*(..)) or "
			+ "execution(* com.mycompany.newgyms.*.dao.*.*(..))")
