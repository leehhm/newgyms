					...
					<div id="contain">
						<div id="contain_right">
							...
							<table id="order_detail">
								...
								<tr>
									...
									<td width="20%"><span id="gray_color">&nbsp;
											${total_price}원</span> <br> <span id="gray_color">&nbsp;
											${myOrderDetail[0].pay_method}</span>
									...
									<td width="20%"><span id="gray_color">&nbsp; <fmt:formatNumber value="${myOrderDetail[0].point_price}" type="number" />원</span><br>
										<span id="gray_color">&nbsp; <fmt:formatNumber value="${myOrderDetail[0].new_point}" type="number" />원</span></td>
								</tr>
								...
								<tr>
									<td colspan="2" style="padding-left: 10px;">예금주 &nbsp; <input
										type="text" size="13" name="account_holder"
										class="cancel_inputbox" required> <br> 취소사유 <select
										name="cancel_reason" class="cancel_inputbox" required>
									...
									<td colspan="3" style="padding-left: 20px;">&nbsp;&nbsp;
										환불은행 <select name="account_bank" class="cancel_inputbox"
										required>
									...
									<td align=right colspan="3" style="padding-right: 10px; font-size: 18px;">환불
										예상금액 <span id="red_color">&nbsp; <fmt:formatNumber
												value="${myOrderDetail[0].refund_price}" type="number" />원
									</span> <input type="hidden" name="refund_price"
										value="${myOrderDetail[0].refund_price}">
									</td>
								</tr>
							</table>
							...
							<input type="hidden" name="order_id"
								value="${myOrderDetail[0].order_id}">

							<div id="align_center">
								<input type="submit" class="submit_btn" value="환불신청"
									onclick="alert('환불 신청이 완료되었습니다.')">

								<div style="margin-top: 10px; display: inline-block;">
									<a
										href="${contextPath}/mypage/myOrderDetail.do?order_id=${myOrderDetail[0].order_id}"
