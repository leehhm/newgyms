...
<title>비회원 주문결제내역조회</title>
</head>
<body>
   <form action="${contextPath}/order/nonMemberOrderCancel.do?total_price=${myOrderDetail[0].total_price}" method="post">
         ...
         <div class="con">
            <div id="contain">
               ...
               <div id="contain_right">
                  <p id="mypage_order_title">비회원 주문/결제 상세 조회</p>
...
<%--                            <span id="gray_color">&nbsp; <fmt:formatNumber value="${myOrderDetail[0].total_price}" type="number" />원</span> <br> --%>
                  ...
                  <div style="text-align:center; margin-top:20px;">
                     <a href="${contextPath}/main/main.do" style="line-height:32px;">
                     <span class="submit_btn2" style="padding:10px 95px 10px 95px;">메인페이지로</span></a>
                  </div>
               </div>
            </div>
         </div>
