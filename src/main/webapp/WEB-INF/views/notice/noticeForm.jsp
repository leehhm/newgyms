		...
		<div class="con">
			<div id="contain">
				...
				<div id="contain_right">
					<p id="notice_title">글 쓰기</p>
					<form name="noticeForm" method="post"
						action="${contextPath}/notice/addNewNotice.do"
						...
						<table id="notice_table2" align=center>
							...
							<tr>
								...
								<td colspan="3" align=left><textarea name="notice_content"
										...
										style="margin-top: 10px; margin-bottom: 20px; padding: 15px; border: 1px solid #D8D8D8"></textarea></td>
							</tr>

							<!-- 이미지 첨부 -->
							<tr>
								<td><span id="notice_textbox">사진</span></td>
								<td width="300px"><img id="preview" src="${contextPath}/resources/image/jss.png" /></td>
								<td align=left style="padding-left:20px;"><input type="file"
									name="notice_image" onchange="readURL(this);"></td>
							</tr>
						</table>
						<div align=center>
