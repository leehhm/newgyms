   ...
   <div class="con-min-width">
      <div class="con">
         ...
         <div id="contain" align=center>
            ...
            <form
               action="${contextPath}/member/joinMember.do?member_name=${member_name}"
               method="post">
               <table id="join_table2">
                  ...
                  <tr>
                     ...
                     <td><input name="member_id" id="member_id"
                        ...
                        pattern="[a-z0-9]{5,20}" required
                        title="아이디는 영문자(소문자)와 숫자로 이루어진 5~20 자리를 입력해주세요."
                        onkeyup="idRegexp()" placeholder="영문, 숫자 혼합 5자리 이상"></td>
                  ...
                  <tr>
                     ...
                     <td><input name="member_pw" id="member_pw"
                        ...
                        onkeyup="pwRegexp()" placeholder="영문, 숫자, 특수문자 혼합 8자리 이상"
                        required /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td colspan="2"><input name="email1" class="join_inputbox"
                        type="text" size="9" pattern="[a-z0-9]{3,20}" required
                        title="이메일 주소를 입력해주세요."> @ <input name="email2"
                        class="join_inputbox" type="text" size="12"> &nbsp; <select
                        name="email_op" class="join_inputbox" required>
                  ...
                  <tr>
                     ...
                     <td><input type="radio" name="member_gender" value="M"
                        ...
                        value="W" /> 여자</td>
                     <td><input type="checkbox" name="emailsts_yn" value="Y"
                        checked /><span id="join_subtext"> 이메일 수신 동의</span></td>
                  </tr>
